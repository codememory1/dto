...
final class DataTransferObjectProtectedPropertyProvider implements DataTransferObjectPropertyProviderInterface
{
    private ?Closure $extension = null;

    public function getProperties(ClassReflector $classReflector): array
    {
        $properties = $classReflector->getPropertiesIncludingParent([AbstractDataTransferObject::class], ReflectionProperty::IS_PROTECTED);
